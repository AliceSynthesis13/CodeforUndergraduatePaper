...
% spectrum = 1 代表输出能量分布图，spectrum = 0 代表输出晶格图
lattice = 0;
spectrum = 0;
...
str1 = strcat('.\Figure\R_OBC_M7_E_type',num2str(type),'.jpg');
str2 = strcat('.\Figure\R_OBC_M7_DoS_type',num2str(type),'.jpg');
% str2 = '.\Figure\type4.jpg';

%首先导出哈密顿量并对角化
H = Real_Hamiltonian(Nx,Ny,type,t,lambda_SO,mu,Delta);
...
if spectrum == 1
    ...
    scatter(6.5:1:13.5,-Y(length(Y)/2-3:length(Y)/2+4),'red','linewidth',2);
